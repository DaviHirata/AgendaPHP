    ...
    <div class="container">
        ...
        <div class="meuContainer">
            ...
            <?php
                ...
                $id = $_GET["id"];
                $resultado = mostrarAgendamentoAlterar($id);
            ?>
            <form method="post" action="../controller/controleAulas.php" class="formulario mb-3" id="formAula">
                <div class="mb-3" for="materia" required>
                    <div class="form-check form-check-inline mb-3">
                        <input class="form-check-input" type="radio" id="matematica" name="materia" value="matematica">
                        <label class="form-check-label" for="matematica">Matemática</label>
                    </div>

                    <div class="form-check form-check-inline mb-3">
                        <input class="form-check-input" type="radio" id="ingles" name="materia" value="ingles">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select form-control" name="tipoAula" id="tipoAula" required>
                        ...
                        <option value="ead">Remota</option>
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="descricao" id="descricao" class="form-control"
                        value="<?= $resultado['descricao'] ?>" required>
                ...
                <div class="row mb-3" id="dataHoraContainer" style="display: none;">
                    <div class="col">
                ...
                <div class="botoes-container">
                    <button type="submit" name="opcao" value="Atualizar" class="botaoVoltar">Salvar</button>
                    <button type="button" class="botaoVoltar" onclick="confirmarExclusao()">Excluir</button>
                    <a href="../view/verAgendamentos.php" class="botaoVoltar">Voltar</a>
                </div>
            </form>

            <form method="post" action="../controller/controleAulas.php" id="formExcluir" style="display: none;">
                <input type="hidden" name="id_agendamento_excluir" value="<?= $resultado['id_aula']; ?>">
                <input type="hidden" name="opcao" value="ExcluirAgendamento">
            </form>
        </div>
    </div>
</body>
...
<script>
// Adicione a função para confirmar exclusão do agendamento
