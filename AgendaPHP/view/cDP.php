...
<head>
    ...
    <title>Cadastrar Professor ou Desenvolvedor</title>
</head>
    ...
    <div class="container">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <button type="button" class="btn-mint"><a class="nav-link"
                                href="paginaLogin.php">Acessar</a></button>
                    </li>
        ...
        <div class="meuContainer">
            ...
            <form method="post" action="../controller/controleUsuario.php" onsubmit="return validarSenhas()">
                ...
                <button type="submit" name="opcao" value="Mestre" class="btn btn-secondary">Cadastrar Usuário</button>
            </form>
        </div>
    </div>
</body>
